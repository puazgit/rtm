...
-- Dumping data for table rtmdb.tb_departemen: ~0 rows (approximately)
...
INSERT INTO `tb_uraian` (`id`, `analisis`, `r_uraian`, `r_target`, `r_pic`, `tindak`, `p_rencana`, `p_realisasi`, `status`, `rtm_id`, `index_id`, `created_at`, `updated_at`) VALUES
	(1, 'Berdasarkan grafik  dapat disimpulkan bahwa Hasil Kuesioner/Indeks Kepuasan Pelanggan menunjukan trend/kecenderungan yang meningkat (positif)', 'Indeks kepuasan pelanggan untuk tahun 2017 masih menggunakan prognosa, menunggu laporan survey kepuasan pelanggan yang masih disusun, ', '', '8,1,2,3', '', '', '', '1', 4, 1, '2019-08-13 03:08:37', '2019-08-13 03:08:37'),
	(2, 'Berdasarkan grafik dapat disimpulkan bahwa Hasil Kuesioner/Indeks Keterikatan Karyawan menunjukan trend/kecenderungan yang menurun (Negatif)', 'Indeks keterikatan karyawan untuk tahun 2017 masih menggunakan data prognosa', '', '3', '', '', '', '0', 4, 2, '2019-08-13 03:08:37', '2019-08-13 03:08:37'),
