...
-- Dumping data for table rtmdb.rtm_uraian: ~5 rows (approximately)
...
INSERT INTO `tb_uraian` (`id`, `uraian`, `analisis`, `r_uraian`, `r_target`, `r_pic`, `tindak`, `p_rencana`, `p_realisasi`, `status`, `created_at`, `updated_at`) VALUES
	(2, '2Indeks Keterikatan Karyawan 7.3.a.(3).3', 'Berdasarkan grafik dapat disimpulkan bahwa Hasil Kuesioner/Indeks Keterikatan Karyawan menunjukan trend/kecenderungan yang menurun (Negatif)', 'Indeks keterikatan karyawan untuk tahun 2017 masih menggunakan data prognosa', '', '3', '', '', '', 0, '2019-08-13 03:08:37', '2019-08-13 03:08:37'),
