...
<head>
    ...
    <link href="{{asset ('assets/css/components-md.min.css')}}" rel="stylesheet" id="style_components"
        type="text/css" />
...
<body class=" login">
    ...
    <div class="content">
        ...
        <form class="login-form" action="{{ route('login') }}" method="POST">
            ...
            <div class="alert alert-danger display-hide">
                ...
                <span class="invalid-feedback" role="alert">Masukkan User dan Password.</span>
            </div>
            @error('email')
            ...
            <input id="email" type="text"
                ...
                placeholder="Email / Username" name="email" value="{{ old('email') }}" required autocomplete="email"
                autofocus />

    </div> --}}
    <div class="form-group">
        <label for="login" class="control-label visible-ie8 visible-ie9">{{ __('Username or Email') }}</label>

        <input id="login" type="text"
            class="form-control form-control-solid placeholder-no-fix {{ $errors->has('username') || $errors->has('email') ? ' is-invalid' : '' }}"
            placeholder="Email / Username" name="email" value="{{ old('username') ?: old('email') }}" required=""
            autofocus="">
    ...
    <div class="form-actions">
        ...
        <a href="{{ route('password.request') }}" id="forget-password"
            class="forget-password">{{ __('Forgot Password?') }}</a>
        @endif --}}
    </div>
