                    ...
                    <div class="portlet-body">
                        <div class="tabbable-bordered">
                            <ul class="nav nav-tabs">
                                <li class="active">
                                    <a href="#tab_rtm" data-toggle="tab"> isian 1 </a>
                                </li>
                                <li>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab_rtm">
                                    <div class="form-body">
                                        <div class="form-group">
                                            <label class="col-md-2 control-label">RTM Ke:
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-2 control-label">Tingkat :
                                                <span class="required"> * </span>
                                            </label>
                                            <div class="col-md-10">
                                                <input type="text" class="form-control" name="" placeholder=""> </div>
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-2 control-label">RKT :
                                                <span class="required"> * </span>
                                            </label>
                                            <div class="col-md-10">
                                                <input type="text" class="form-control" name="" placeholder=""> </div>
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-2 control-label">Tahun :
                                                <span class="required"> * </span>
                                            </label>
                                            <div class="col-md-10">
                                                <input type="text" class="form-control" name="" placeholder=""> </div>
